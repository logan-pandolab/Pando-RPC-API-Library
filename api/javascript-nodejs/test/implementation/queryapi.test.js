...
it('get account', async () => {
  ...
  expect(pandowei).toBeDefined()
  expect(ptxwei).toBeDefined()
...
it('get transaction', async () => {
  ...
  expect(proposer.coins.pandowei).toBeDefined()
  expect(proposer.coins.ptxwei).toBeDefined()
  expect(proposer.sequence).toBeDefined()
  expect(proposer.signature).toBeDefined()

  expect(outputs[0].address).toBeDefined()
  expect(outputs[0].coins.pandowei).toBeDefined()
  expect(outputs[0].coins.ptxwei).toBeDefined()
})
